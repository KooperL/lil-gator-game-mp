...
{
	// (get) Token: 0x0600080F RID: 2063 RVA: 0x00007EE6 File Offset: 0x000060E6
	...
	// Token: 0x06000810 RID: 2064 RVA: 0x00007EFD File Offset: 0x000060FD
	private void Start()
	{
		this.SetState(GameData.g.ReadBool(this.saveID, false));
	}

	// Token: 0x06000811 RID: 2065 RVA: 0x00007F16 File Offset: 0x00006116
	public void Hit(Vector3 velocity)
	{
		this.SetState(true);
	}

	// Token: 0x06000812 RID: 2066 RVA: 0x00007F1F File Offset: 0x0000611F
